...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppPagesServicesDatabaseServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var DatabaseService = /*#__PURE__*/function () {
      function DatabaseService(plt, router, sqlitePorter, sqlite, http) {
        var _this = this;
        ...
        this.sqlite = sqlite;
        this.http = http;
        this.dbReady = new rxjs__WEBPACK_IMPORTED_MODULE_7__["BehaviorSubject"](false);
        this.songs = new rxjs__WEBPACK_IMPORTED_MODULE_7__["BehaviorSubject"]([]);
        this.selectedPath = '';
      ...
      _createClass(DatabaseService, [{
        key: "customDatabase",
        value: function customDatabase() {
          var _this2 = this;

          this.http.get('assets/custom.sql', {
            responseType: 'text'
        ...
        value: function loadSongs() {
          ...
          return this.database.executeSql('SELECT * FROM song', []).then(function (data) {
            var songs = [];
            ...
            _this3.songs.next(songs);
          });
        }
      }, {
        key: "getSongs",
        value: function getSongs(id) {
          return this.database.executeSql('SELECT * FROM song WHERE id = ?', [id]).then(function (data) {
            return {
    ...
    DatabaseService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _ionic_native_sqlite_porter_ngx__WEBPACK_IMPORTED_MODULE_4__["SQLitePorter"], _ionic_native_sqlite_ngx__WEBPACK_IMPORTED_MODULE_6__["SQLite"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClient"]])], DatabaseService);
    /***/
  }
}]);
