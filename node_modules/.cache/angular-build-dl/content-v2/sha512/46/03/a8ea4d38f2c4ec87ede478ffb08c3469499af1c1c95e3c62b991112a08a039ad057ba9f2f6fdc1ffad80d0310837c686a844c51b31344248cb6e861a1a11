...
const routes = [
    ...
    {
        path: 'detail/:id',
        loadChildren: () => Promise.all(/*! import() | pages-detail-detail-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-detail-detail-module")]).then(__webpack_require__.bind(null, /*! ./pages/detail/detail.module */ "./src/app/pages/detail/detail.module.ts")).then(m => m.DetailPageModule)
    },
];
...
/* harmony import */ var _pages_services_event_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./pages/services/event.service */ "./src/app/pages/services/event.service.ts");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, events) {
        ...
        this.initializeApp();
        this.initializeApp();
        this.events.subscribe('update:font-family', (className) => {
...
AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
        ...
        _pages_services_event_service__WEBPACK_IMPORTED_MODULE_5__["EventService"]])
], AppComponent);
...
let EventService = class EventService {
     ...
     */
    publish(topic, data) {
        const subject = this.channels[this.fontFamily];
        if (!subject) {
...
module.exports = __webpack_require__(/*! /home/mofrey/miya/src/main.ts */"./src/main.ts");
